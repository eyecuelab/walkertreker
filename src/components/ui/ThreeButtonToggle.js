  ...
  render() {
    return (
      <View style={threeButtonToggleStyles.container}>
        <Text style={[styles.label, { margin: 5, marginBottom: 0 }]}>
          {this.props.title}
        </Text>
        <Text style={[styles.plainText, { margin: 0 }]}>
          {this.props.subtitle}
        </Text>
        <View style={threeButtonToggleStyles.buttonContainer}>
          ...
          >
            <ButtonToggle
              ...
              active={this.state.activeFlags[0]}
          ...
          >
            <ButtonToggle
              ...
              active={this.state.activeFlags[1]}
              bigValue={this.props.bigValue}
            />
          </TouchableHighlight>
          <TouchableHighlight
          ...
          >
            <ButtonToggle
              ...
              active={this.state.activeFlags[2]}
              bigValue={this.props.bigValue}
            />
          </TouchableHighlight>
        </View>

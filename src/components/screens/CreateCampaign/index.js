...
class CreateCampaign extends React.Component {
  ...
  shouldComponentUpdate(nextProps, nextState) {
    const shouldUpdate =
      nextProps.campaign.players &&
      nextProps.campaign.players.length > 0 &&
      this.props.campaign.players &&
      this.props.campaign.players.length === 0;
    return shouldUpdate;
  }
          ...
          <View style={styles.container}>
            ...
            <View style={createCampaignStyle.buttonContainer}>
              <ButtonWithLoading
                ...
                onButtonPress={this._generateCampaign}
              />
            </View>
          </View>
        </ImageBackground>
